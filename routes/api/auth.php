...
//    'middleware' => 'api',
    ...
    Route::post('social/{provider}/signup', 'SocialAuthController@signupFromSocialProvider')->name('social-signup');
    Route::post('idp/{provider}/signup', 'SocialAuthController@signupFromIdentityProvider')->name('sso-signup');
});
