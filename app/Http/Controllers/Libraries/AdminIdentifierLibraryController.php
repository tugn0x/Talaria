...
use App\Models\Libraries\IdentifierLibraryTransformer;
use Illuminate\Http\Request;

class AdminIdentifierLibraryController extends AdminApiController
{
        /**
     ...
     * @return void
     */
    public function __construct(IdentifierLibrary $model, IdentifierLibraryTransformer $transformer)
    {
        $this->model = $model;
