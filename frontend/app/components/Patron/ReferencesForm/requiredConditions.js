export const requiredConditions = (formData) => {
    ...
    const page_start = (!formData.page_start ||formData.page_start === null) ? "" : formData.page_start;
    const first_author = (!formData.first_author ||formData.first_author === null) ? "" : formData.first_author;
