...
const Pagination = (props) => {
    ...
    return (
        ...
        (<div className="pagination">
            ...
            <Button className="step-backward" color="link" onClick={() => linkToPage(current_page-1, per_page)} disabled={current_page !== 1 ? false : true}>
                <i className="fas fa-step-backward"></i>
            </Button>
            <Button className="step-forward" color="link" onClick={() => linkToPage(current_page+1, per_page)} disabled={current_page !== total_pages ? false : true}>
