...
import { SYNC_AUTH, STOP_LOADING, REQUEST_LOGIN, 
        REQUEST_LOGOUT, REQUEST_REFRESH, REQUEST_LOGIN_SUCCESS, 
        REQUEST_LOGOUT_SUCCESS, REQUEST_REFRESH_SUCCESS, 
        REQUEST_ERROR, REQUEST_SIGNUP, REQUEST_SIGNUP_SUCCESS, 
        REQUEST_PROFILE, REQUEST_PROFILE_SUCCESS , REQUEST_PERMISSIONS, 
        REQUEST_PERMISSIONS_SUCCESS, REQUEST_VERIFICATION, 
        REQUEST_VERIFICATION_SUCCESS, REQUEST_NEW_TOKEN, 
        REQUEST_NEW_TOKEN_SUCCESS, REQUEST_CHANGE_PASSWORD, 
        REQUEST_CHANGE_PASSWORD_SUCCESS, REQUEST_FORGOT_PASSWORD, 
        REQUEST_FORGOT_PASSWORD_SUCCESS, REQUEST_RESET_PASSWORD, 
        REQUEST_RESET_PASSWORD_SUCCESS, REQUEST_UPDATE_PROFILE, 
        REQUEST_UPDATE_PROFILE_SUCCESS, REQUEST_DELETE_PROFILE, 
        REQUEST_DELETE_PROFILE_SUCCESS, SOCIAL_LOGIN_PREPARE, 
        SOCIAL_LOGIN_REQUEST, SOCIAL_LOGIN_SUCCESS, REQUEST_IDP_SIGNUP } from './constants';
